...
export interface NexusGenFieldTypes {
  Mutation: { // field return type
    createTrip: NexusGenRootTypes['TripOffering'] | null; // TripOffering
  }
  Query: { // field return type
    categories: Array<NexusGenRootTypes['TripCategory'] | null> | null; // [TripCategory]
  }
  TripCategory: { // field return type
    id: number | null; // Int
    name: string | null; // String
  }
...
export interface NexusGenFieldTypeNames {
  Mutation: { // field return type name
    createTrip: 'TripOffering'
  }
  Query: { // field return type name
    categories: 'TripCategory'
  }
  TripCategory: { // field return type name
    id: 'Int'
    name: 'String'
  }
